...
public class ShipmentAvailableListFinishFragment extends Fragment {
    ...
    public ShipmentAvailableListFinishFragment() {
    ...
    private void setObservers(){
        shipmentViewModel.readShipmentsFinished(partnerUid).observe(getViewLifecycleOwner(), new Observer<List<ShipmentDto>>() {
            @Override
