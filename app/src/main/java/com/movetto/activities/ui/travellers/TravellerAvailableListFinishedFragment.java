...
public class TravellerAvailableListFinishedFragment extends Fragment {
    ...
    public TravellerAvailableListFinishedFragment() {
    ...
    private void setObservers(){
        travelViewModel.readTravelsFinished(partnerUid).observe(getViewLifecycleOwner(), new Observer<List<TravelDto>>() {
            @Override
