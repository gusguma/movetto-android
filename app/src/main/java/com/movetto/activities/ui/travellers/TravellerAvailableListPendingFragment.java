...
public class TravellerAvailableListPendingFragment extends Fragment {
    ...
    public TravellerAvailableListPendingFragment() {
    ...
    private void setObservers(){
        travelViewModel.readTravelsPending(partnerUid).observe(getViewLifecycleOwner(), new Observer<List<TravelDto>>() {
            @Override
