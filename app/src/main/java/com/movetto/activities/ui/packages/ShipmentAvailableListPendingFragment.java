...
public class ShipmentAvailableListPendingFragment extends Fragment {
    ...
    public ShipmentAvailableListPendingFragment() {
    ...
    private void setObservers(){
        shipmentViewModel.readShipmentsPending(partnerUid).observe(getViewLifecycleOwner(), new Observer<List<ShipmentDto>>() {
            @Override
