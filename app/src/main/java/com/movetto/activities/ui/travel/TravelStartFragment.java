...
public class TravelStartFragment extends Fragment
    ...
    private void setLayout(LayoutInflater inflater, ViewGroup container) {
        root = inflater.inflate(R.layout.fragment_travel_start, container, false);
    }

    private void setComponents() {
        street = root.findViewById(R.id.travel_start_customer_street_edit);
        postalCode = root.findViewById(R.id.travel_start_customer_cp_edit);
        city = root.findViewById(R.id.travel_start_customer_city_edit);
        state = root.findViewById(R.id.travel_start_customer_state_edit);
        country = root.findViewById(R.id.travel_start_customer_country_edit);
        buttonContinue = root.findViewById(R.id.travel_start_customer_continue_button);
    }
    ...
    public void onFocusChange(View v, boolean hasFocus) {
        ...
        if (editText.hasFocus()){
            ...
            if(editText.getId() == R.id.travel_start_customer_cp_edit){
                isPostalCodeValid();
            }
        }
    }
    ...
    private void setPartnerBundle(){
        ...
        Navigation.findNavController(root).navigate(
                R.id.action_nav_travel_start_to_nav_travel_end, data);
    }
